...
-->
	<!--MARC21slim2MODS3-4 (Revision 1.62) 20101202
...
-->
		...
		<!--
remove when done	<xsl:apply-templates select="marc:datafield[653 &gt;= @tag and @tag &gt;= 600]"/>
-->
		...
		<!-- 856, 020, 024, 022, 028, 010, 037 put identifiers back in 20101123 -->
