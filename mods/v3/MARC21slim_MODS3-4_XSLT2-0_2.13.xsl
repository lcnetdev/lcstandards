<xsl:stylesheet xmlns="http://www.loc.gov/mods/v3" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:marc="http://www.loc.gov/MARC21/slim"
...
<!--	<xsl:include href="../MARC21slimUtils.xsl"/>-->
	...
	<!-- 
		...
		MARC21slim2MODS3-4 (Revision 2.13) 20121101
	...
	<xsl:template match="marc:record">
		...
		<!-- Call titleInfo templates and linking fields-->
			...
			<xsl:apply-templates select="marc:datafield[@tag='740'][@ind2 !='2'] | marc:datafield[@tag='880'][starts-with(marc:subfield[@code='6'],'740')]" mode="titleInfo"/>
			<xsl:apply-templates select="marc:datafield[@tag='730'][@ind2 !='2'] | marc:datafield[@tag='880'][starts-with(marc:subfield[@code='6'],'730')]" mode="titleInfo"/>
			<!-- titleInfo type="translated" -->
...
<!--			<xsl:apply-templates select="marc:datafield[@tag='880']"/>-->
			<xsl:apply-templates select="marc:datafield[@tag='264'] | marc:datafield[@tag='880'][starts-with(marc:subfield[@code='6'],'264')]" mode="orginInfo"/>
		...
		-->
			<xsl:apply-templates select="marc:datafield[@tag='245'] | marc:datafield[@tag='880'][starts-with(marc:subfield[@code='6'],'245')]
				| marc:datafield[@tag='362'] | marc:datafield[@tag='880'][starts-with(marc:subfield[@code='6'],'362')]
				| marc:datafield[starts-with(@tag,'5')] | marc:datafield[@tag='880'][starts-with(marc:subfield[@code='6'],'5')]" mode="note"/>
		...
		<!-- Call subject templates -->
			...
			<!-- 6XX: subjects -->
			<xsl:apply-templates select="marc:datafield[@tag='600'] | marc:datafield[@tag='880'][starts-with(marc:subfield[@code='6'],'600')] 
				...
				| marc:datafield[@tag='752'] | marc:datafield[@tag='880'][starts-with(marc:subfield[@code='6'],'752')]" mode="subject"/>
		...
		<!-- Call templates for related item -->
			...
			<xsl:apply-templates select="marc:datafield[@tag='700'][marc:subfield[@code='t']]" mode="relatedItem"/>
			<xsl:apply-templates select="marc:datafield[@tag='710'][marc:subfield[@code='t']]" mode="relatedItem"/>
			<xsl:apply-templates select="marc:datafield[@tag='711'][marc:subfield[@code='t']]" mode="relatedItem"/>
			...
			<xsl:apply-templates select="marc:datafield[@tag='760'] | marc:datafield[@tag='765'] | 
				...
				marc:datafield[@tag='785'] | marc:datafield[@tag='786']" mode="relatedItem"/>
		...
		<!-- Create recordInfo template -->
			<recordInfo>
				...
				<recordOrigin>Converted from MARCXML to MODS version 3.4 using MARC21slim2MODS3-4_XSL2-0.xsl
					(Revision 2.13 2012/11/01)</recordOrigin>
...
<!-- titleInfo Templates: 130 210 240 245 246 730 740 -->
	...
	<xsl:template match="marc:datafield[@tag='130'] | marc:datafield[@tag='880'][@ind2!='2'][starts-with(marc:subfield[@code='6'],'130')]
		| marc:datafield[@tag='730'][@ind2!='2'] | marc:datafield[@tag='880'][@ind2!='2'][starts-with(marc:subfield[@code='6'],'730')]" mode="titleInfo">
			<titleInfo type="uniform">
		...
		<titleInfo type="translated">
			...
			<xsl:choose>
				...
				<xsl:when test="@ind2 != '0'">
					<nonSort>
						<xsl:value-of select="substring(local:stripPunctuation($title),1,(@ind2 cast as xs:integer))"/>
					</nonSort>					
					<title>
						<xsl:value-of select="substring(local:stripPunctuation($title),(@ind2 cast as xs:integer)+1)"/>
					</title>
				</xsl:when>
				<xsl:otherwise>
					<title>
			...
			<xsl:variable name="title">	
				<xsl:choose>
					<xsl:when test="marc:subfield[@code='b']">
						...
						<xsl:value-of select="local:specialSubfieldSelect(.,'','b','afgks','')"></xsl:value-of>
					</xsl:when>
					<xsl:otherwise>
	...
	<xsl:template match="marc:datafield[@tag='240'] | marc:datafield[@tag='880'][starts-with(marc:subfield[@code='6'],'240')]" mode="titleInfo">
		<titleInfo type="uniform">
			...
			<xsl:variable name="str">
				<xsl:choose>
					<xsl:when test="ends-with($str1,' ')"><xsl:value-of select="substring($str1,1,string-length($str1)-1)"/></xsl:when>
...
<!--				<xsl:value-of select="local:stripPunctuation(local:subfieldSelect(.,'adfklmors'))"/>-->
	...
	<xsl:template match="marc:datafield[@tag='740'][@ind2 !='2'] | marc:datafield[@tag='880'][starts-with(marc:subfield[@code='6'],'740')]" mode="titleInfo">
...
<!-- name templates -->
	...
	<xsl:template match="marc:datafield[@tag='100'][not(marc:subfield[@code='t'])] | marc:datafield[@tag='880'][starts-with(marc:subfield[@code='6'],'100')][not(marc:subfield[@code='t'])]
		| marc:datafield[@tag='700'][not(marc:subfield[@code='t'])] | marc:datafield[@tag='880'][starts-with(marc:subfield[@code='6'],'700')][not(marc:subfield[@code='t'])]" mode="name">
			<name>
				<!-- name attributes -->
				<xsl:choose>
				...
				<xsl:if test="@tag='100'"><xsl:attribute name="usage">primary</xsl:attribute></xsl:if>
				<!-- Template checks for altRepGroup - 880 $6 -->
				<xsl:call-template name="xxx880"/>
				<!-- Add nameTitleGroup attribute if necessary -->
				<xsl:call-template name="nameTitleGroup"/>
				...
				<xsl:if test="marc:subfield[@code='0']">
					<xsl:attribute name="xlink"><xsl:value-of select="marc:subfield[@code='0']"/></xsl:attribute>
				</xsl:if>
				<!-- namePart -->
				<xsl:for-each select="marc:subfield[@code='a']">
					<namePart>
						<xsl:value-of select="local:stripPunctuation(local:subfieldSelect(parent::*,'aq'))"/>
					</namePart>
				</xsl:for-each>
	...
	<!-- 111 711 name -->
	<xsl:template match="marc:datafield[@tag='111'] | marc:datafield[@tag='880'][starts-with(marc:subfield[@code='6'],'111')]
		| marc:datafield[@tag='711'][not(marc:subfield[@code='t'])] | marc:datafield[@tag='880'][starts-with(marc:subfield[@code='6'],'711')][not(marc:subfield[@code='t'])]" mode="name">
		<xsl:if test="marc:subfield[@code!='t']">
	...
	<xsl:template name="genre">
		...
		<xsl:apply-templates select="marc:datafield[@tag='047'][@ind2='7'] | marc:datafield[@tag='880'][starts-with(marc:subfield[@code='6'],'047')]" mode="genre"/>
	...
	<xsl:template match="marc:datafield[@tag='047'][@ind2='7'] | marc:datafield[@tag='880'][starts-with(marc:subfield[@code='6'],'047')]" mode="genre">
	...
	<!-- Leader and control field parameters passed from record template -->
		...
		<xsl:if test="marc:datafield[@tag='044' or @tag='260' or @tag='046' or @tag='033' or @tag='250' or @tag='310' or @tag='321'] or marc:controlfield[@tag='008']">		
			<originInfo>
				...
				<xsl:apply-templates select="marc:datafield[@tag='044']/marc:subfield[@code='c']" mode="orginInfo"/>	
				...
				<xsl:apply-templates select="marc:datafield[@tag='250']/marc:subfield[@code='a']" mode="orginInfo"/>
				...
				<xsl:apply-templates select="marc:datafield[@tag='310']|marc:datafield[@tag='321']" mode="orginInfo"/>
				<xsl:if test="$typeOf008='SE'">
		...
		<xsl:if test="marc:datafield[@tag='880'][starts-with(marc:subfield[@code='6'],'260')] 
			...
			<originInfo>
				...
				<xsl:for-each select="marc:datafield[@tag='880'][starts-with(marc:subfield[@code='6'],'260')] 
				...
				<xsl:apply-templates select="marc:datafield[@tag='880'][starts-with(marc:subfield[@code='6'],'260')]/child::*" mode="orginInfo"/>
				<xsl:apply-templates select="marc:datafield[@tag='880'][starts-with(marc:subfield[@code='6'],'250')]/marc:subfield[@code='a']" mode="orginInfo"/>
				<xsl:apply-templates select="marc:datafield[@tag='880'][starts-with(marc:subfield[@code='6'],'044')]/marc:subfield[@code='c']" mode="orginInfo"/>
				<xsl:apply-templates select="marc:datafield[@tag='880'][starts-with(marc:subfield[@code='6'],'046')]" mode="orginInfo"/>
				<xsl:apply-templates select="marc:datafield[@tag='880'][starts-with(marc:subfield[@code='6'],'033')]" mode="orginInfo"/>
				<xsl:apply-templates select="marc:datafield[@tag='880'][starts-with(marc:subfield[@code='6'],'310')]" mode="orginInfo"/>
				<xsl:apply-templates select="marc:datafield[@tag='880'][starts-with(marc:subfield[@code='6'],'321')]" mode="orginInfo"/>
			</originInfo>
		</xsl:if>
	</xsl:template>	
	...
	<xsl:template match="marc:datafield[@tag='264']" mode="orginInfo">
		<xsl:if test="@ind2 ='0' or @ind2 ='1'or @ind2 ='2' or @ind2 ='3'">
			<originInfo>
				<xsl:choose>
					<xsl:when test="@ind2='0'"><xsl:attribute name="displayLabel">producer</xsl:attribute></xsl:when>
					<xsl:when test="@ind2='1'"><xsl:attribute name="displayLabel">publisher</xsl:attribute></xsl:when>
					<xsl:when test="@ind2='2'"><xsl:attribute name="displayLabel">distributor</xsl:attribute></xsl:when>
					<xsl:when test="@ind2='3'"><xsl:attribute name="displayLabel">manufacturer</xsl:attribute></xsl:when>
				</xsl:choose>
				<xsl:call-template name="xxx880"/>
	...
	<!-- orginInfo place 044 -->
	<xsl:template match="marc:datafield[@tag='044']/marc:subfield[@code='c'] | marc:datafield[@tag='880'][starts-with(marc:subfield[@code='6'],'044')]/marc:subfield[@code='c']" mode="orginInfo">
		<place>
			<placeTerm>
				<xsl:attribute name="type">code</xsl:attribute>
	...
	<xsl:template match="marc:datafield[@tag='260']/child::* | marc:datafield[@tag='880'][starts-with(marc:subfield[@code='6'],'260')]/child::*" mode="orginInfo">
		<xsl:param name="leader6"/>
		<xsl:choose>
	...
	<xsl:template match="marc:datafield[@tag='046'] | marc:datafield[@tag='880'][starts-with(marc:subfield[@code='6'],'046')]" mode="orginInfo">
	...
	<xsl:template match="marc:datafield[@tag='033'] | marc:datafield[@tag='880'][starts-with(marc:subfield[@code='6'],'033')]" mode="orginInfo">
	...
	<!-- orginInfo edition -->
	<xsl:template match="marc:datafield[@tag='250']/marc:subfield[@code='a'] | marc:datafield[@tag='880'][starts-with(marc:subfield[@code='6'],'250')]/marc:subfield[@code='a']" mode="orginInfo">
		<edition>
			<xsl:apply-templates/>
		</edition>		
	</xsl:template>
			...
			<xsl:for-each select="marc:subfield[@code='a' or @code='b' or @code='d' or @code='e' or @code='f' or @code='g' or @code='h' or @code='j']">
				...
				<xsl:variable name="langStrMulti">
					<xsl:for-each-group select="string-to-codepoints($langStr)" group-by="(position() - 1) idiv 3">
						<temp><xsl:sequence select="codepoints-to-string(current-group())"/></temp>
					</xsl:for-each-group>
				</xsl:variable>
				...
				<xsl:choose>
					...
					<xsl:otherwise>
						<language>
							...
							<xsl:choose>							
								<xsl:when test="@code='b'"><xsl:attribute name="objectPart">summary</xsl:attribute></xsl:when>
								<xsl:when test="@code='d'"><xsl:attribute name="objectPart">sung or spoken text</xsl:attribute></xsl:when>
								<xsl:when test="@code='e'"><xsl:attribute name="objectPart">libretto</xsl:attribute></xsl:when>
								<xsl:when test="@code='f'"><xsl:attribute name="objectPart">table of contents</xsl:attribute></xsl:when>
								<xsl:when test="@code='g'"><xsl:attribute name="objectPart">accompanying material</xsl:attribute></xsl:when>
								<xsl:when test="@code='h'"><xsl:attribute name="objectPart">translation</xsl:attribute></xsl:when>
								<xsl:when test="@code='j'"><xsl:attribute name="objectPart">subtitle or caption</xsl:attribute></xsl:when>									
							</xsl:choose>							
							<languageTerm>
								<!-- Adds appropriate type and authority attributes -->
									<xsl:choose>
	...
	<xsl:template name="physicalDescription">
		...
		<xsl:if test="marc:datafield[@tag='880'][starts-with(marc:subfield[@code='6'],'130')][child::*[@code='h']] or 
			...
			<physicalDescription>
				...
				<xsl:apply-templates select="marc:datafield[@tag='880'][starts-with(marc:subfield[@code='6'],'130')]/marc:subfield[@code='h'] 
					...
					| marc:datafield[@tag='880'][starts-with(marc:subfield[@code='6'],'256')]/marc:subfield[@code='a']" mode="physDesc"/>				
				<xsl:apply-templates select="marc:datafield[@tag='880'][starts-with(marc:subfield[@code='6'],'856')]/child::*[code='q']" mode="physDesc"/>
				<xsl:apply-templates select="marc:datafield[@tag='880'][starts-with(marc:subfield[@code='6'],'300')]" mode="physDesc"/>
			</physicalDescription>
		</xsl:if>
	</xsl:template>
	...
	<xsl:template name="form">
		...
		<xsl:apply-templates select="marc:datafield[@tag='130']/marc:subfield[@code='h'] | marc:datafield[@tag='240']/marc:subfield[@code='h'] | 
			...
			| marc:datafield[@tag='256']/marc:subfield[@code='a'] | marc:datafield[@tag='337']/marc:subfield[@code='a'] | marc:datafield[@tag='338']/marc:subfield[@code='a']" mode="physDesc"/>
	</xsl:template>
	...
	-->
	<xsl:template match="marc:datafield[@tag='130']/marc:subfield[@code='h'] 
		...
		| marc:datafield[@tag='880'][starts-with(marc:subfield[@code='6'],'245')]/marc:subfield[@code='h'] 
		| marc:datafield[@tag='880'][starts-with(marc:subfield[@code='6'],'246')]/marc:subfield[@code='h'] 
		| marc:datafield[@tag='880'][starts-with(marc:subfield[@code='6'],'730')]/marc:subfield[@code='h']" mode="physDesc">
		<form authority="gmd">
	...
	<xsl:template match="marc:datafield[@tag='337']/marc:subfield[@code='a'] | marc:datafield[@tag='880'][starts-with(marc:subfield[@code='6'],'337')]/marc:subfield[@code='a']" mode="physDesc">
		<form>
			...
			<xsl:attribute name="type"><xsl:text>media</xsl:text></xsl:attribute>
			<xsl:apply-templates/>
		</form>
	</xsl:template>
	...
	<xsl:template match="marc:datafield[@tag='338']/marc:subfield[@code='a'] | marc:datafield[@tag='880'][starts-with(marc:subfield[@code='6'],'338')]/marc:subfield[@code='a']" mode="physDesc">
		<form>
			...
			<xsl:attribute name="type"><xsl:text>carrier</xsl:text></xsl:attribute>
			<xsl:apply-templates/>
		</form>
	</xsl:template>	
	...
	<xsl:template match="marc:datafield[@tag='520'] | marc:datafield[@tag='880'][starts-with(marc:subfield[@code='6'],'520')]" mode="abstract">
		<abstract>
			...
			<xsl:choose>
				<xsl:when test="@ind1='0'"><xsl:attribute name="displayLabel">Subject</xsl:attribute></xsl:when>
				<xsl:when test="@ind1='1'"><xsl:attribute name="displayLabel">Review</xsl:attribute></xsl:when>
				<xsl:when test="@ind1='2'"><xsl:attribute name="displayLabel">Scope and content</xsl:attribute></xsl:when>
				<xsl:when test="@ind1='3'"><xsl:attribute name="displayLabel">Abstract</xsl:attribute></xsl:when>
				<xsl:when test="@ind1='4'"><xsl:attribute name="displayLabel">Content advice</xsl:attribute></xsl:when>
				<xsl:when test="@ind1='8'"/>
				<xsl:otherwise><xsl:attribute name="displayLabel">Summary</xsl:attribute></xsl:otherwise>
			</xsl:choose>
			<!-- Template checks for altRepGroup - 880 $6 -->			
			<xsl:call-template name="xxx880"/>
	...
	<xsl:template match="marc:datafield[@tag='505'] | marc:datafield[@tag='880'][starts-with(marc:subfield[@code='6'],'505')]" mode="toc">
		<tableOfContents>
			...
			<xsl:choose>		
				<xsl:when test="@ind1='0'"><xsl:attribute name="displayLabel">Contents</xsl:attribute></xsl:when>
				<xsl:when test="@ind1='1'"><xsl:attribute name="displayLabel">Incomplete contents</xsl:attribute></xsl:when>
				<xsl:when test="@ind1='2'"><xsl:attribute name="displayLabel">Partial contents</xsl:attribute></xsl:when>
				<xsl:otherwise/>
			</xsl:choose>
			<!-- Template checks for altRepGroup - 880 $6 -->
			<xsl:call-template name="xxx880"/>
	...
	<xsl:template name="targetAudience">
		...
		<xsl:if test="$typeOf008='BK' or 'CF' or 'MU' or 'VM'">
			...
			<xsl:choose>
				<xsl:when test="$controlField008-22='d'"><targetAudience authority="marctarget">adolescent</targetAudience></xsl:when>
				<xsl:when test="$controlField008-22='e'"><targetAudience authority="marctarget">adult</targetAudience></xsl:when>
				<xsl:when test="$controlField008-22='g'"><targetAudience authority="marctarget">general</targetAudience></xsl:when>
				<xsl:when test="$controlField008-22='b'"><targetAudience authority="marctarget">juvenile</targetAudience></xsl:when>
				<xsl:when test="$controlField008-22='c'"><targetAudience authority="marctarget">juvenile</targetAudience></xsl:when>
				<xsl:when test="$controlField008-22='j'"><targetAudience authority="marctarget">juvenile</targetAudience></xsl:when>
				<xsl:when test="$controlField008-22='a'"><targetAudience authority="marctarget">preschool</targetAudience></xsl:when>
				<xsl:when test="$controlField008-22='f'"><targetAudience authority="marctarget">specialized</targetAudience></xsl:when>
				<xsl:otherwise/>
			</xsl:choose>			
		</xsl:if>
	...
	<xsl:template match="marc:datafield[@tag='521'] | marc:datafield[@tag='880'][starts-with(marc:subfield[@code='6'],'521')]" mode="targetAudience">
		<targetAudience>
			<!-- Add displayLabel attribute -->
			<xsl:choose>	
				<xsl:when test="@ind1='0'"><xsl:attribute name="displayLabel">Reading grade level</xsl:attribute></xsl:when>
				<xsl:when test="@ind1='1'"><xsl:attribute name="displayLabel">Interest age level</xsl:attribute></xsl:when>
				<xsl:when test="@ind1='2'"><xsl:attribute name="displayLabel">Interest grade level</xsl:attribute></xsl:when>
				<xsl:when test="@ind1='3'"><xsl:attribute name="displayLabel">Special audience characteristics</xsl:attribute></xsl:when>
				<xsl:when test="@ind1='4'"><xsl:attribute name="displayLabel">Motivation or interest level</xsl:attribute></xsl:when>
				<xsl:when test="@ind1='8'"/>
			...
			<note type="statement of responsibility">
				...
				<xsl:if test="child::marc:subfield[@code='6']">
					...
					<xsl:attribute name="altRepGroup">
						...
						<xsl:value-of select="$sf06b"/><xsl:value-of select="$sf06b"/>
					</xsl:attribute>
					<xsl:call-template name="scriptCode"/>
				</xsl:if>				
				<xsl:call-template name="scriptCode"/>
	...
	<!-- General Note field -->
	<xsl:template match="marc:datafield[@tag='500'] | marc:datafield[@tag='880'][starts-with(marc:subfield[@code='6'],'500')]
		...
		| marc:datafield[starts-with(@tag,'59')] | marc:datafield[@tag='880'][starts-with(marc:subfield[@code='6'],'59')]" mode="note">
		<note>
			<!-- Template checks for altRepGroup - 880 $6 -->	
			<xsl:call-template name="xxx880"/>
			<xsl:call-template name="uri"/>
	...
	<xsl:template match="marc:datafield[@tag='255'][child::*[@code='a' or @code='b' or @code='c']]
		| marc:datafield[@tag='880'][starts-with(marc:subfield[@code='6'],'255')][child::*[@code='a' or @code='b' or @code='c']]" mode="subject">
		<subject>
			<!-- Template checks for altRepGroup - 880 $6 -->
			<xsl:call-template name="xxx880"/>					
	...
	<xsl:template match="marc:datafield[@tag='611'] | marc:datafield[@tag='880'][starts-with(marc:subfield[@code='6'],'611')]" mode="subject">
		<subject>
			...
			<name type="conference">
				<namePart>
					<xsl:value-of select="local:subfieldSelect(.,'abcdeqnp')"></xsl:value-of>
				</namePart>
				<!-- role -->
	...
	<xsl:template match="marc:datafield[@tag='630'] | marc:datafield[@tag='880'][starts-with(marc:subfield[@code='6'],'630')]" mode="subject">
		<subject>
			...
			<titleInfo>
				<title>
					<xsl:value-of select="local:stripPunctuation(local:subfieldSelect(.,'adfhklor'))"/>
				</title>
				<xsl:apply-templates select="marc:subfield[@code='n']" mode="titleInfo"/>
	...
	<xsl:template match="marc:datafield[@tag='662'] | marc:datafield[@tag='880'][starts-with(marc:subfield[@code='6'],'662')] 
		| marc:datafield[@tag='752'] | marc:datafield[@tag='880'][starts-with(marc:subfield[@code='6'],'752')]" mode="subject">
		<subject>
			<!-- Template checks for altRepGroup - 880 $6 -->
			<xsl:call-template name="xxx880"/>					
	...
	<xsl:template match="marc:subfield[@code='a'] | marc:subfield[@code='b']" mode="namePart">
		<namePart>
			<xsl:choose>
				<xsl:when test="@code='a'"><xsl:value-of select="local:stripPunctuation(local:subfieldSelect(parent::*,'aq'))"/></xsl:when>
				<xsl:otherwise><xsl:value-of select="local:stripPunctuation(.)"/></xsl:otherwise>
			</xsl:choose>
		</namePart>
	</xsl:template>
	...
	<xsl:template match="marc:subfield[@code='v']" mode="subject">
		<genre><xsl:value-of select="local:stripPunctuation(.)"/></genre>
	</xsl:template>
	<!-- subfield x: topic -->
	<xsl:template match="marc:subfield[@code='x']" mode="subject">
		<topic><xsl:value-of select="local:stripPunctuation(.)"/></topic>
	</xsl:template>
	<!-- subfield y: temporal -->
	<xsl:template match="marc:subfield[@code='y']" mode="subject">
		<temporal><xsl:value-of select="local:stripPunctuation(.)"/></temporal>
	</xsl:template>
	<!-- subfield z: geographic -->
	<xsl:template match="marc:subfield[@code='z']" mode="subject">
		<geographic><xsl:value-of select="local:stripPunctuation(.)"/></geographic>
	</xsl:template>
				...
				<url displayLabel="electronic resource">
					...
					<xsl:variable name="primary">
						<xsl:choose>
							...
							<xsl:when test="@ind2!='1' and @ind2!='0' and 
	...
	<xsl:template match="marc:datafield[@tag='490'][@ind1='0']" mode="relatedItem">
		...
		<relatedItem type="series">
			<xsl:for-each select=". | ../marc:datafield[@tag='880'][starts-with(marc:subfield[@code='6'],'490')][matches(substring(marc:subfield[@code='6'],5,2),$s6)]">
				<titleInfo>
					<!-- Template checks for altRepGroup - 880 $6 -->
					<xsl:call-template name="xxx880"/>					
					<title>
					...
					<xsl:if test="marc:subfield[@code='v']">
						<partNumber><xsl:value-of select="local:stripPunctuation(marc:subfield[@code='v'])"/></partNumber>
					</xsl:if>
				</titleInfo>
			</xsl:for-each>
		</relatedItem>
	...
	<xsl:template match="marc:datafield[@tag='440']" mode="relatedItem">
		<xsl:variable name="s6" select="substring(normalize-space(marc:subfield[@code='6']), 5, 2)"/>
		<relatedItem type="series">
			<xsl:for-each select=". | ../marc:datafield[@tag='880'][starts-with(marc:subfield[@code='6'],'440')][matches(substring(marc:subfield[@code='6'],5,2),$s6)]">
				<titleInfo>
					<!-- Template checks for altRepGroup - 880 $6 -->
					<xsl:call-template name="xxx880"/>	
					<title>
	...
	<xsl:template match="marc:datafield[@tag='510']" mode="relatedItem">
		...
		<relatedItem type="isReferencedBy">
			<xsl:for-each select=". | ../marc:datafield[@tag='880'][starts-with(marc:subfield[@code='6'],'510')][matches(substring(marc:subfield[@code='6'],5,2),$s6)]">
				<xsl:for-each select="marc:subfield[@code='a']">
					<titleInfo>
						<!-- Template checks for altRepGroup - 880 $6 -->
						<xsl:call-template name="xxx880"/>	
	...
	<xsl:template match="marc:datafield[@tag='534']" mode="relatedItem">
		...
		<relatedItem type="original">
			<xsl:for-each select=". | ../marc:datafield[@tag='880'][starts-with(marc:subfield[@code='6'],'534')][matches(substring(marc:subfield[@code='6'],5,2),$s6)]">
				<!-- call title template -->
	...
	<xsl:template match="marc:datafield[@tag='700'][marc:subfield[@code='t']]" mode="relatedItem">
		...
		<relatedItem>
			...
			<xsl:for-each select=". | ../marc:datafield[@tag='880'][matches(substring(marc:subfield[@code='6'],5,2),$s6)][marc:subfield[@code='t']]">
				<titleInfo>
					<xsl:call-template name="xxx7xxt"/>
					<title>
						<xsl:value-of select="local:stripPunctuation(local:specialSubfieldSelect(.,'tfklmorsv','t','','g'))"/>
					</title>
		...
		<relatedItem>
			...
			<name type="corporate">
				...
				<xsl:variable name="tempNamePart">
					<xsl:value-of select="local:specialSubfieldSelect(.,'c','t','dgn','')"></xsl:value-of>
				</xsl:variable>
	...
	<xsl:template match="marc:datafield[@tag='711'][marc:subfield[@code='t']]" mode="relatedItem">
		...
		<relatedItem>
			...
			<titleInfo>
				<xsl:call-template name="xxx880"/>
				<title>
					<xsl:value-of select="local:stripPunctuation(local:specialSubfieldSelect(.,'tfklsv','t','','g'))"/>
				</title>
				<xsl:apply-templates select="marc:subfield[@code='n']" mode="relatedItem"/>
				<xsl:apply-templates select="marc:subfield[@code='p']" mode="relatedItem"/>
			</titleInfo>
	...
	<xsl:template match="marc:datafield[@tag='730'][@ind2='2']" mode="relatedItem">
		...
		<relatedItem>
			...
			<xsl:for-each select=". | ../marc:datafield[@tag='880'][starts-with(marc:subfield[@code='6'],'730')][matches(substring(marc:subfield[@code='6'],5,2),$s6)]">
			<titleInfo>
				<xsl:call-template name="xxx880"/>
				<title>
					<xsl:value-of select="local:stripPunctuation(local:subfieldSelect(.,'adfgklmorsv'))"></xsl:value-of>
				</title>
				<xsl:apply-templates select="marc:subfield[@code='n']" mode="relatedItem"/>
				<xsl:apply-templates select="marc:subfield[@code='p']" mode="relatedItem"/>
			</titleInfo>
	...
	<xsl:template match="marc:datafield[@tag='760'] | marc:datafield[@tag='765'] | 
		marc:datafield[@tag='767'] | marc:datafield[@tag='762'] | 
		marc:datafield[@tag='770'] | marc:datafield[@tag='774'] | marc:datafield[@tag='775'] |
		marc:datafield[@tag='772'] | marc:datafield[@tag='773'] |
		marc:datafield[@tag='776'] | marc:datafield[@tag='780'] |
		...
		<relatedItem>
			...
			<xsl:for-each select=". | ../marc:datafield[@tag='880'][matches(substring(marc:subfield[@code='6'],5,2),$s6)]">
			<!-- title -->
			...
			<xsl:if test="@tag='775'">
				<xsl:if test="marc:subfield[@code='e']">
					<language>
						<xsl:call-template name="xxx880"/>
						<languageTerm type="code" authority="iso639-2b"><xsl:value-of select="marc:subfield[@code='e']"/></languageTerm>
					</language>
				</xsl:if>
			</xsl:if>
	...
	<xsl:template match="marc:datafield[@tag='800']" mode="relatedItem">
		...
		<relatedItem type="series">
			...
			<name type="personal">
				<xsl:call-template name="xxx880"/>
				<namePart>
					<xsl:value-of select="local:stripPunctuation(local:specialSubfieldSelect(.,'aq','t','g',''))"/>
				</namePart>
				<xsl:apply-templates select="marc:subfield[@code='b']" mode="termsOfAddress"/>
				<xsl:apply-templates select="marc:subfield[@code='d']" mode="nameDate"/>
				<xsl:apply-templates select="marc:subfield[@code='e'] | marc:subfield[@code='4']" mode="role"/>
	...
	<xsl:template match="marc:datafield[@tag='810']" mode="relatedItem">
		...
		<relatedItem type="series">
			...
			<titleInfo>
				<xsl:call-template name="xxx880"/>
				<title>
					<xsl:value-of select="local:stripPunctuation(local:specialSubfieldSelect(.,'tfklmorsv','t','','dg'))"/>
				</title>
				<xsl:apply-templates select="marc:subfield[@code='n']" mode="relatedItem"/>
				<xsl:apply-templates select="marc:subfield[@code='p']" mode="relatedItem"/>
			</titleInfo>
			<name type="corporate">
				...
				<namePart>
					<xsl:value-of select="local:stripPunctuation(local:specialSubfieldSelect(.,'c','t','dgn',''))"/>
				</namePart>
				<xsl:apply-templates select="marc:subfield[@code='e'] | marc:subfield[@code='4']" mode="role"/>
			</name>
			<!-- physical description form -->
	...
	<xsl:template match="marc:datafield[@tag='811']" mode="relatedItem">
		...
		<relatedItem type="series">
			...
			<name type="conference">
				<xsl:call-template name="xxx880"/>
				<namePart>
					<xsl:value-of select="local:stripPunctuation(local:specialSubfieldSelect(.,'aqdc','t','gn',''))"/>
				</namePart>
				<xsl:apply-templates select="marc:subfield[@code='e'] | marc:subfield[@code='4']" mode="role"/>
			</name>
			<!-- physical description form -->
	...
	<xsl:template match="marc:datafield[@tag='830']" mode="relatedItem">
		...
		<relatedItem type="series">
			...
			<titleInfo>
				<xsl:call-template name="xxx880"/>
				<title>
					<xsl:value-of select="local:stripPunctuation(local:subfieldSelect(.,'adfgklmorsv'))"/>
				</title>
				<xsl:apply-templates select="marc:subfield[@code='n']" mode="relatedItem"/>
				<xsl:apply-templates select="marc:subfield[@code='p']" mode="relatedItem"/>
			</titleInfo>
...
<!-- Related Item common subfields -->
	...
	<xsl:template match="marc:subfield[@code='t']" mode="relatedItem">
		<titleInfo>
			...
			<!-- call part numbers -->
			<xsl:apply-templates select="following-sibling::marc:subfield[@code='n']" mode="relatedItem"/>
			<xsl:apply-templates select="../marc:subfield[@code='p']" mode="relatedItem"/>
			<xsl:apply-templates select="../marc:subfield[@code='g']" mode="relatedItem"/>
		</titleInfo>
	</xsl:template>
	...
	<xsl:template match="marc:subfield[@code='n']" mode="relatedItem">
		<xsl:choose>
			<xsl:when test="parent::marc:datafield[@tag='710' or @tag='810' or @tag='711' or @tag='811']">
	...
	<xsl:template match="marc:subfield[@code='g']" mode="relatedItem">
		<xsl:if test="parent::marc:datafield[@tag='760' or @tag='762' or @tag='765' 
...
<!-- Create Identifiers -->
			...
			<identifier>
				...
				<xsl:choose>
					...
					<xsl:when test="@ind1='7' and marc:subfield[@code='2']">
						<xsl:attribute name="type"><xsl:value-of select="marc:subfield[@code='2']"/></xsl:attribute>
					</xsl:when>
	...
	<xsl:template match="marc:datafield[@tag='028'] | marc:datafield[@tag='880'][starts-with(marc:subfield[@code='6'],'028')]" mode="id">
		<identifier>
			...
			<xsl:choose>
				<xsl:when test="@ind1='0'"><xsl:value-of select="local:subfieldSelect(.,'ba')"/></xsl:when>
				<xsl:otherwise><xsl:value-of select="local:subfieldSelect(.,'ab')"/></xsl:otherwise>
			</xsl:choose>
		</identifier>
	</xsl:template>
	...
	<xsl:template name="nameTitleGroup">
		<xsl:choose>
			...
			<xsl:when test="self::marc:datafield[@tag='880'][starts-with(marc:subfield[@code='6'],'240')]">
				<xsl:choose>
					<xsl:when test="../marc:datafield[@tag='880'][starts-with(marc:subfield[@code='6'],'100')] or 
			...
			<xsl:when test="(self::marc:datafield[@tag='880'][starts-with(marc:subfield[@code='6'],'100')]
