...
<!-- 
This stylesheet transforms MODS 3.2 to simple Dublin Core, based on the Library of Congress' MODS to simple DC mapping available here <http://www.loc.gov/standards/mods/mods-dcsimple.html>. 

The stylesheet tranforms a collection of MODS to the DC SRU schema at <http://www.loc.gov/standards/sru/dc-schema.xsd> 
The stylesheet transforms a single mods record to the DC OAI schema at <http://www.openarchives.org/OAI/2.0/oai_dc.xsd>
		
Because MODS is more granular than DC, transforming a given MODS element or subelement to a DC element frequently results in less precise tagging, and local customizations of the stylesheet may 
be necessary to achieve desired results. This stylesheet makes the following decisions in its interpretation of the MODS to simple DC mapping: 
...
Version 1.0	2007-05-08 created by Tracy Meehleib <tmee@loc.gov>
-->
